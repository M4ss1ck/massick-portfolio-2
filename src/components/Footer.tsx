...
export const Footer = () => {
    return (
        <footer className="flex flex-col items-center justify-center mt-auto z-20 lg:transition text-sm sm:text-lg bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg w-full py-4">
